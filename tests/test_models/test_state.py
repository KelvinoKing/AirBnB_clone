#!/usr/bin/python3
"""import state module to build tests
and unittest
"""
...
class TestState(unittest.TestCase):
    """TestState inherits from the TestCase class.
    All test cases of State class are carried out in this class
    """

    def test_inequality_of_two_different_objects_ids(self):
        """Tests if two obj ids of different instances of State class
        are equal
        """
    ...
    def test_inequality_of_two_instances_of_state(self):
        """Test if two instances of State class are equal
        """
    ...
    def test_state_originates_from_base_model(self):
        """Tests if State class inherits from the python object class
        """

        obj = State()
        self.assertIsInstance(obj, BaseModel)

    def test_printing_instance_of_state(self):
        """Tests if the State class str() method returns a string in
        a specified format
        """
    ...
    def test_deserialization_and_reloading_from_json(self):
        ...
        new_obj = State(**json.loads(obj_json))
